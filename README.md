...
| UPOP.FRONTURL | `https://</span>ipay-staging.ipayafrica.com/upop/unionpaycbk/frontRcvResponse.php` | The callback URL that receives the notice from UnionPay's foreground | 
